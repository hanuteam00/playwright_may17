...
//Kiểu pages nên bao gồm các thuộc tính tương ứng với các trang bạn muốn sử dụng trong các bài kiểm tra của mình. Trong trường hợp của bạn, pages có thể được định nghĩa như sau
type pages = {
